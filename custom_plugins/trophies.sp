...
public OnPluginStart()  {
   ...
   //Init natives
   CreateNative("Trophies_Get", NativeGet);
   CreateNative("Trophies_Set", NativeSet);
...
public NativeGet(Handle:plugin, numParams)
{
...
public NativeSet(Handle:plugin, numParams)
{
    new client = GetNativeCell(1);
